# Este archivo puede ser eliminado si no se requiere más, ya que ahora estamos usando MySQL en AWS RDS.
# Si necesitas realizar operaciones específicas de la base de datos, considera usar SQLAlchemy.
